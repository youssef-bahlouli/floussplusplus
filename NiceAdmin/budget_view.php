...
<head>
  ...
  <title>Enregistrements - budget</title>
...
<ul class="sidebar-nav" id="sidebar-nav">
    ...
    <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
      <li>
        <a href="./depenses_view.php">
          <i class="bi bi-circle"></i><span>Les Dépenses</span>
        </a>
      </li>
      <li>
  ...
  <li class="nav-item">
    <a class="nav-link collapsed" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#">
      <i class="bi bi-journal-text"></i><span>Déclaration</span><i class="bi bi-chevron-down ms-auto"></i>
    </a>
    <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
      ...
      <li>
        <a href="./depenses_add.php">
          <i class="bi bi-circle"></i><span>dépenses</span>
        </a>
      </li>
      <li>
...
<!-- End Sidebar-->
  ...
  <script src="assets/js/depenses-check.js"></script>
